...
1. Give crocheters an easier time with counting their stitches. 
    ...
    - have a row counter
    - name "markers" and keep notes on what they mean. 
...
2. Allow for flow while crocheting
    ...
    - allow one to create a pattern on-the-go - this is helpful if one wants to refine their item and keep track of what was done.


### User Journeys 


The very basic first step. 
